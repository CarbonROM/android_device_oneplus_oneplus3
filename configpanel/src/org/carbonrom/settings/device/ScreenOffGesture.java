...
import java.io.File;
import org.carbonrom.settings.device.utils.AppHelper;
import org.carbonrom.settings.device.utils.ActionConstants;
import org.carbonrom.settings.device.utils.DeviceUtils;
import org.carbonrom.settings.device.utils.DeviceUtils.FilteredDeviceFeaturesArray;

import org.carbonrom.settings.device.R;
import org.carbonrom.settings.device.utils.ShortcutPickerHelper;
...
*/
        ...
        sFinalActionDialogArray = DeviceUtils.filterUnsupportedDeviceFeatures(getActivity(),
                getResources().getStringArray(
                        R.array.shortcut_action_screen_off_values),
                getResources().getStringArray(
                        R.array.shortcut_action_screen_off_entries));
